        ...
        [
            {
                "name":"アナトミア平静峡谷 平原地域",
                "svg":`
<svg id="towerA" width="64px" height="64px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
	<title>敵タワー</title>
	<path d="M0,0 L0,10 6,16 10,16 16,10 16,0" fill="rgb(248,170,174)" />
	<path d="M1,1 L1,10 6,15 10,15 15,10 15,1" fill="rgb(193,41,51)" />
</svg>
<svg id="towerB" width="64px" height="64px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
	<title>味方タワー</title>
	<path d="M0,0 L0,10 6,16 10,16 16,10 16,0" fill="rgb(119,152,93)" />
	<path d="M1,1 L1,10 6,15 10,15 15,10 15,1" fill="rgb(14,74,134)" />
</svg>
<br>
