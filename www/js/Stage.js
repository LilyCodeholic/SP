...
-->
    <symbol id="wordA" viewbox="0 0 16 16">
        <path d="M5,12 L8,4 11,12 M6,9 H10" fill="none" stroke-width="6%" />
    </symbol>
    ...
    <symbol id="port" viewbox="0 0 16 16">
        <title>ポート</title>
        <path d="M8,1.5 A6.5,6.5,0,0,0,8,14.5 A6.5,6.5,0,0,0,8,1.5" stroke-width="20%" />
    </symbol>

    <symbol id="assault" viewbox="0 0 16 16">
        <title>アサルト</title>
        <path d="M15,11 L12,11 6,10 1,8 6,6 12,5 15,5 15,11 12,5" stroke-width="7%" stroke-linecap="round" stroke-linejoin="round" />
    </symbol>
    <symbol id="vanguard" viewBox="0 0 16 16">
        <title>ヴァンガード</title>
        <path d="M11,2 L14,2 14,14 4,14 2,12 2,4 4,2 11,2 11,14" stroke-width="7%" stroke-linecap="round" stroke-linejoin="round" />
    </symbol>
    <symbol id="support" viewBox="0 0 16 16">
        <title>サポート</title>
        <path d="M14,3 L13,8 A5,6,0,0,0,3,8 A2,3,0,0,0,7,8 A2,3,0,0,0,3,8 A5,6,0,0,0,13,8 L14,13 13,8" stroke-width="7%" stroke-linecap="round" stroke-linejoin="round" />
    </symbol>

    <symbol id="core" viewBox="0 0 16 16">
        <title>コア</title>
        <path d="M8,2 L2,8 8,14 14,8" />
    </symbol>
    ...
    <symbol id="airgrande" viewBox="0 0 16 16">
        <title>エア・グランデ</title>
        <g id="airgrande_base">
            <path d="M8,2 L4,12 8,16 12,12" />
        </g>
        <g id="airgrande_edge">
            <path d="M4,12 L8,2 12,12" fill="none" stroke-width="7%" />
        </g>
    </symbol>
    <symbol id="airgrande_arrow" viewBox="0 0 16 16">
        <title>エア・グランデの軌跡</title>
        <path d="M8,0 L0,8 h4 v8 h8 v-8 h4 Z" />
    </symbol>
</svg>
...
<svg width="128px" height="64px" viewBox="0 0 32 16" xmlns="http://www.w3.org/2000/svg">
    ...
    <use xlink:href="#tower" x="16" y="0" width="16" height="16" fill="rgb(14,74,134)" stroke="rgb(102,151,187)" />
</svg>
<svg width="320px" height="64px" viewBox="0 0 80 16" xmlns="http://www.w3.org/2000/svg">
    <use xlink:href="#port" x="0" y="0" width="16" height="16" fill="rgb(128,128,128)" stroke="rgb(192,192,192)" />
    <use xlink:href="#wordA" x="0" y="0" width="16" height="16" stroke="rgb(192,192,192)" />
</svg>
<svg width="384px" height="64px" viewBox="0 0 96 16" xmlns="http://www.w3.org/2000/svg">
    <use xlink:href="#assault" x="0" y="0" width="16" height="16" fill="rgb(193,41,51)" stroke="rgb(255,104,114)" />
    <use xlink:href="#vanguard" x="16" y="0" width="16" height="16" fill="rgb(193,41,51)" stroke="rgb(255,104,114)" />
    <use xlink:href="#support" x="32" y="0" width="16" height="16" fill="rgb(193,41,51)" stroke="rgb(255,104,114)" />
    <use xlink:href="#assault" x="48" y="0" width="16" height="16" fill="rgb(14,74,134)" stroke="rgb(102,151,187)" />
    <use xlink:href="#vanguard" x="64" y="0" width="16" height="16" fill="rgb(14,74,134)" stroke="rgb(102,151,187)" />
    <use xlink:href="#support" x="80" y="0" width="16" height="16" fill="rgb(14,74,134)" stroke="rgb(102,151,187)" />
</svg>
<svg width="128px" height="64px" viewBox="0 0 32 16" xmlns="http://www.w3.org/2000/svg">
    <use xlink:href="#core" x="0" y="0" width="16" height="16" fill="rgb(255,104,114)" />
    <use xlink:href="#barrier" x="0" y="0" width="16" height="16" />
    <use xlink:href="#core" x="16" y="0" width="16" height="16" fill="rgb(104,114,255)" />
    <use xlink:href="#barrier" x="16" y="0" width="16" height="16" />
</svg>
<svg width="128px" height="64px" viewBox="0 0 32 16" xmlns="http://www.w3.org/2000/svg">
...
<svg width="128px" height="128px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    <use xlink:href="#airgrande_base" x="0" y="16" width="16" height="16" fill="rgb(12,122,211)" />
    <use xlink:href="#airgrande_edge" x="0" y="16" width="16" height="16" stroke="rgb(177,212,218)" />
    <use xlink:href="#airgrande_arrow" x="0" y="0" width="16" height="16" fill="rgb(82,152,214)" />
    <use xlink:href="#airgrande_base" x="16" y="16" width="16" height="16" fill="rgb(211,12,122)" />
    <use xlink:href="#airgrande_edge" x="16" y="16" width="16" height="16" stroke="rgb(218,177,212)" />
    <use xlink:href="#airgrande_arrow" x="16" y="0" width="16" height="16" fill="rgb(214,82,152)" />
</svg>
